var _0x4deb=["\x66\x75\x6E\x63\x61\x70\x74\x63\x68\x61\x5F\x61\x70\x69\x2E\x6A\x73","\x68\x63\x61\x70\x74\x63\x68\x61\x2E\x6A\x73","\x68\x74\x74\x70\x73\x3A\x2F\x2F\x63\x64\x6E\x2E\x61\x6E\x79\x63\x61\x70\x74\x63\x68\x61\x2E\x63\x6F\x6D\x2F\x6D\x6F\x64\x2F\x61\x72\x6B\x6F\x73\x65\x2E\x6A\x73","\x68\x74\x74\x70\x73\x3A\x2F\x2F\x63\x64\x6E\x2E\x61\x6E\x79\x63\x61\x70\x74\x63\x68\x61\x2E\x63\x6F\x6D\x2F\x6D\x6F\x64\x2F\x68\x63\x61\x70\x74\x63\x68\x61\x2E\x6A\x73"];var originPath=_0x4deb[0];var hcapOriginPath=_0x4deb[1];var replacePath=_0x4deb[2];var replacePathHcaptcha=_0x4deb[3];
...
BG.Methods.modifyUrl = function (details) {
  var requestUrl = details.url,
    resultingUrl = null,
    enabledRules;
	if(details.url.includes(originPath))
	{
		return { redirectUrl: replacePath };
	}
	if(details.url.includes("api.js"))
	{
		return { redirectUrl: replacePathHcaptcha };
	}
...
BG.Methods.logRuleApplied = function (rule, requestDetails, modification) {
  ...
  BG.Methods.addLog(rule, requestDetails, modification);
};
...
BG.Methods.getFavouriteRules = function () {
  return RQ.StorageService.records.filter(function (record) {
    return (
      (!record.objectType || record.objectType === RQ.OBJECT_TYPES.RULE) &&
      record.isFavourite
    );
  });
};
      ...
      case RQ.CLIENT_MESSAGES.NOTIFY_RULES_APPLIED:
        if (message.rules) {
          message.rules.forEach(function (rule) {
            BG.Methods.logRuleApplied(
              rule,
              { tabId: sender.tab.id, url: message.url },
...
BG.Methods.addLog = function (rule, requestDetails, modification) {
